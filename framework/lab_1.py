...
print("Тест: Сложение и накопление градиента")
...
print(f"Градиент 'a' (должен быть [2, 2, 2]): {a.grad.data}")
print(f"Градиент 'b' (должен быть [1, 1, 1]): {b.grad.data}")
